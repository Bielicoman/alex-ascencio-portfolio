...
export const SKILLS = ["Edição cinematográfica", "Transmissão ao vivo", "Color grading", "Operação de câmera", "Direção e roteiro", "Motion / VFX", "Fluxos com IA generativa"];
export const EDU = [
...
export const SOCIAL = {
  ...
  whatsapp: "https://wa.me/5515997569880",
  email: "mailto:ascencioalexgabriel@gmail.com",
  portfolio: "https://alex-ascencio-portfolio.vercel.app",
};
export const SUMMARY = "Alex Ascencio é editor de vídeo e filmmaker há mais de 5 anos, entre videoclipes, documentários, cinema, turnês internacionais e transmissões ao vivo. Hoje edita e finaliza conteúdo institucional na União Noroeste Brasileira. Foi filmmaker oficial da turnê de 45 anos do Prisma Brasil nos Estados Unidos, e tem trabalhos exibidos na TV Novo Tempo e no Feliz7Play. Corta pela cena, não pela fala, e usa IA generativa como ferramenta de produção: se não passa como filmado, não entra.";
